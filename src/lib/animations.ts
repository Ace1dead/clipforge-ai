...
export const ANIMATION_PRESETS: { type: AnimationType; name: string; category: string; icon: string }[] = [
  ...
  { type: 'fade_in', name: 'Fade In', category: 'basic', icon: '◐' },
  { type: 'fade_out', name: 'Fade Out', category: 'basic', icon: '◑' },
  { type: 'fade_in_out', name: 'Fade In/Out', category: 'basic', icon: '◒' },
  { type: 'slide_left', name: 'Slide Left', category: 'slide', icon: '◀' },
  { type: 'slide_right', name: 'Slide Right', category: 'slide', icon: '▶' },
  { type: 'slide_up', name: 'Slide Up', category: 'slide', icon: '△' },
  { type: 'slide_down', name: 'Slide Down', category: 'slide', icon: '▽' },
  { type: 'zoom_in', name: 'Zoom In', category: 'zoom', icon: '⊕' },
  { type: 'zoom_out', name: 'Zoom Out', category: 'zoom', icon: '⊖' },
  { type: 'zoom_bounce', name: 'Zoom Bounce', category: 'zoom', icon: '⊛' },
  { type: 'rotate_cw', name: 'Rotate CW', category: 'rotate', icon: '↻' },
  { type: 'rotate_ccw', name: 'Rotate CCW', category: 'rotate', icon: '↺' },
  { type: 'bounce_in', name: 'Bounce In', category: 'bounce', icon: '⬆' },
  { type: 'bounce_out', name: 'Bounce Out', category: 'bounce', icon: '⬇' },
  { type: 'bounce', name: 'Bounce', category: 'bounce', icon: '⏫' },
  { type: 'elastic', name: 'Elastic', category: 'bounce', icon: '〰' },
  { type: 'swing', name: 'Swing', category: 'bounce', icon: '🏓' },
  { type: 'glitch_in', name: 'Glitch In', category: 'glitch', icon: '⚡' },
  { type: 'glitch_out', name: 'Glitch Out', category: 'glitch', icon: '⚡' },
  { type: 'flip_x', name: 'Flip X', category: '3d', icon: '🪞' },
  { type: 'flip_y', name: 'Flip Y', category: '3d', icon: '🪃' },
  { type: 'blur_in', name: 'Blur In', category: 'blur', icon: '🔵' },
  { type: 'blur_out', name: 'Blur Out', category: 'blur', icon: '⚫' },
  { type: 'typewriter', name: 'Typewriter', category: 'text', icon: '⌨' },
]
