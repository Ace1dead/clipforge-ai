...
import {
  ...
  Lightbulb, Calculator, CreditCard, Play, Trash2, ArrowRight, Zap, Radar, Film, Layers, Wand2,
} from 'lucide-react'
...
const QUICK: { to: string; label: string; desc: string; icon: ReactNode; accent?: boolean }[] = [
  ...
  { to: '/tools/movie-summarizer', label: 'Movie Summarizer', desc: 'Summarize full movies with AI cuts', icon: <Film size={20} /> },
...
const TOOLS: { to: string; label: string; icon: ReactNode; group: string }[] = [
  ...
  { to: '/tools/templates', label: 'Templates', icon: <Wand2 size={15} />, group: 'Create' },
  { to: '/tools/movie-summarizer', label: 'Movie Summarizer', icon: <Film size={15} />, group: 'Create' },
